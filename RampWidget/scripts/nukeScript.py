...
class MyRamp(qRampWidget.QRampWidget):
    ...
    def load(self):
        ...
        for index in key_order:
            ...
            position = key_positions[ramp_index]
            value = key_values[ramp_index]
            key_type = int(key_types[ramp_index])
            bezier01_position = bezier_handle_positions[ramp_index * 2]
            bezier01_value = bezier_handle_values[ramp_index * 2]
            bezier02_position = bezier_handle_positions[ramp_index * 2 + 1]
            bezier02_value = bezier_handle_values[ramp_index * 2 + 1]
